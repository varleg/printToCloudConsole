...
export declare class DurableOrchestrationContext {
     ...
     * @param instanceId A unique ID to use for the sub-orchestration instance.
     */
    callSubOrchestratorWithRetry(name: string, retryOptions: RetryOptions, input?: unknown, instanceId?: string): Task;
    /**
     * Schedules a durable HTTP call to the specified endpoint.
     *
     * @param req The durable HTTP request to schedule.
     */
    callHttp(method: string, uri: string, content?: string | object, headers?: {
        [key: string]: string;
