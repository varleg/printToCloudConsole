...
class Entity {
    ...
    handle(context) {
        return __awaiter(this, void 0, void 0, function* () {
            const entityBinding = classes_1.Utils.getInstancesOf(context.bindings, new classes_1.DurableEntityBindingInfo(new classes_1.EntityId("samplename", "samplekey"), true, "", []))[0];
